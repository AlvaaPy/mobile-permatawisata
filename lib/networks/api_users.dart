  ...
  static Future<Map<String, String?>> login(
    ...
    if (response.statusCode == 200) {
      ...
      final profilePictureUrl = (profilePicture != null &&
          ...
          ? 'http://192.168.186.1:8000/uploads/profile_pictures/$profilePicture'
          : 'http://192.168.186.1:8000/uploads/profile_pictures/default.png';
    ...
    if (response.statusCode == 200) {
      ...
      final profileData = {
        ...
        'profile_picture': (data['data']['profile_picture'] != null)
            ? 'http://192.168.186.1:8000/uploads/profile_pictures/${data['data']['profile_picture']}'
            : 'http://192.168.186.1:8000/uploads/profile_pictures/default.png',
      };
