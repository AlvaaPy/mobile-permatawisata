  ...
  static Future<Map<String, String?>> login(
    ...
    if (response.statusCode == 200) {
      ...
      final profilePictureUrl = (profilePicture != null &&
          ...
          ? 'https://be.permata.tifpsdku.com/uploads/profile_pictures/$profilePicture'
          : 'https://be.permata.tifpsdku.com/uploads/profile_pictures/default.png';
    ...
    if (response.statusCode == 200) {
      ...
      final profileData = {
        ...
        'profile_picture': (data['data']['profile_picture'] != null)
            ? 'https://be.permata.tifpsdku.com/uploads/profile_pictures/${data['data']['profile_picture']}'
            : 'https://be.permata.tifpsdku.com/uploads/profile_pictures/default.png',
      };
