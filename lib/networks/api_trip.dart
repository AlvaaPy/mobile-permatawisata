    ...
    if (response.statusCode == 200) {
      ...
      return tripData.map<Map<String, dynamic>>((trip) {
        return {
          ...
          'picture':
              'https://be.permata.tifpsdku.com/uploads/img/trip/${trip['picture']}', // URL gambar utama
        };
      }).toList();
    } else {
      throw Exception(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        const String mainImageBaseUrl =
            'https://be.permata.tifpsdku.com/uploads/img/trip/';
        const  String assetImageBaseUrl =
            'https://be.permata.tifpsdku.com/uploads/img/assetstrip/';
        ...
        return {
          ...
          "package_trip_asset": List<Map<String, dynamic>>.from(
            data["package_trip_asset"].map((asset) => {
                  ...
                  "picture":
                      '$assetImageBaseUrl${asset["picture"].split('assetstrip/').last}', // Gambar tambahan tanpa duplikasi path
                }),
          ),
        };
      } else {
